...
public class Tutosto5 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        charactors[3] = GameObject.Find("Canvas").transform.Find("chasel").GetComponent<Image>();// 서포트
    ...
    void Update()
    {
        ...
        if (strCnt == 4)
        {
            ...
            SceneManager.UnloadSceneAsync("Tuto_sto5");
    ...
    {
        // 대화 내용을 하나하나 추가합니다.
        talking[0] = "'고블린은 인간과의 동맹을 맺었는데 어째서 이런곳에?'";
        talking[1] = "'크르르...인간..죽인다...'";
        talking[2] = "'저녀석 눈이 반쯤 풀렸는데? 우선 해치우자'";
        talking[3] = "";
        talking[4] = "";
