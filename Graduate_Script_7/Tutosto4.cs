...
public class Tutosto4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        charactors[0] = GameObject.Find("Canvas").transform.Find("archer").GetComponent<Image>();
        charactors[1] = GameObject.Find("Canvas").transform.Find("wizard").GetComponent<Image>();
        charactors[2] = GameObject.Find("Canvas").transform.Find("skill").GetComponent<Image>();// 서포트
    ...
    void Update()
    {
        ...
        if (strCnt == 3)
        {
            ...
            SceneManager.UnloadSceneAsync("Tuto_sto4");
    ...
    {
        // 대화 내용을 하나하나 추가합니다.
        talking[0] = "'뭐야 공격이 안통하잖아'";
        talking[1] = "'그냥 공격 말고 기술을 써봐요!'";
        talking[2] = "";
        talking[3] = "";
