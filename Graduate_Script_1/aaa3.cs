...
public class aaa3 : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.C) && isClicked == false && button2.enabled == true)
        {
            OnButtonClick();
        }
    ...
    public void OnButtonClick()
    {
        ...
        player3.transform.position = bigboss.transform.position;
        if (spawnCheck)
            return;
        spawnCheck = true;
