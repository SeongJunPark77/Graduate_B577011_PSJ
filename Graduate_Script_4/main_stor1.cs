...
public class main_stor1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        charactors[1] = GameObject.Find("Canvas").transform.Find("archer1").GetComponent<Image>();
    ...
    void Update()
    {
        ...
        if (strCnt == 4)
        {
            ...
            SceneManager.UnloadSceneAsync("main_sto1");
    ...
    void initialized()
    {
        // 대화 내용을 하나하나 추가합니다.
        talking[0] = "'크르르릉...'";
        talking[1] = "'호랑아, 길 좀 비켜줘'";
        talking[2] = "'크릉..이 뒤로는 갈 수 없다...'";
        talking[3] = "'그럼 너를 죽이고 지나갈 수 밖에, 갈길이 바쁘다고'";
        talking[4] = "";
        ////////////////////////////////////////
