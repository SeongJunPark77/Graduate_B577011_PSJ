...
public class main_stor3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (strCnt == 7)
        {
            ...
            SceneManager.UnloadSceneAsync("main_sto3");
    ...
    {
        // 대화 내용을 하나하나 추가합니다.
        talking[0] = "'그쪽이 오고 있다는 이야기는 들었다'";
        talking[1] = "'들었다면 대화가 통하겠군, 길을 열어줘'";
        talking[2] = "'너는 둘 중 어느쪽이지?'";
        talking[3] = "'둘 중 어느쪽이냐니... 아까부터 만나는 녀석들마다 이상한 소리를 하고 있어'";
        talking[4] = "'이럴 시간이 없어, 빨리 눈의마녀를 무찌르고 저주를 풀어야해요'";
        talking[5] = "'알 수 없군... 하지만 어느 쪽인지 확신할 수 없는 지금, 너희를 여기로 들일순 없다'";
        talking[6] = "'결국 또 이렇게 되는건가'";
        talking[7] = "";
        ////////////////////////////////////////
