...
public class main_stor2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        charactors[3] = GameObject.Find("Canvas").transform.Find("nothing1").GetComponent<Image>();
        // 각 배열에 오브젝트를 연결합니다.
    ...
    void Update()
    {
        ...
        if (strCnt == 6)
        {
            ...
            SceneManager.UnloadSceneAsync("main_sto2");
    ...
    {
        // 대화 내용을 하나하나 추가합니다.
        talking[0] = "'더이상은 앞으로 갈 수 없다'";
        talking[1] = "'눈의 마녀는 저쪽에 있나요?'";
        talking[2] = "'눈의 마녀..? 그 분을 말하는건가'";
        talking[3] = "'그 분? 미안한데 싸울게 아니라면 길좀 비켜줘'";
        talking[4] = "'어떤 사유로든 지금 저쪽으로는 갈 수 없다'";
        talking[5] = "'그렇다면 너를 무찌르고 나아갈 수 밖에'";
        talking[6] = "";
        ////////////////////////////////////////
